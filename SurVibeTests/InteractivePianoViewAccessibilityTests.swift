...
struct InteractivePianoViewAccessibilityTests {
    ...
    @Test
    func defaultHandColorsUseRangTokens() {
    ...
    @Test
    func rangTokensAreStaticColorExtensions() {
    ...
    @Test
    func environmentAccessibilityDifferentiateWithoutColorAPIExists() {
    ...
    @Test
    func differentiateOverlayLettersAreUnique() {
        let letters = ["R", "L", "•"]
