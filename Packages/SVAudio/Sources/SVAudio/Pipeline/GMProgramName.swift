...
/// General MIDI Level 1 program-number to human-readable label.
///
/// Standard GM patch names for instruments 0–127. Used by `PartSplitter`
/// as a fallback label when SMF meta events don't carry track/instrument names.
public enum GMProgramName {
    /// Return the GM instrument name for the given program number.
    ///
    /// - Parameter program: MIDI program number (0–127). Values ≥ 128 clamp to 0.
